                        ...
                        <div class="card-inner-group">
                            <div class="card-inner">
                                <div class="card-title-group">
                                    ...
                                    <div class="card-tools"><a href="user-list-regular.html"
                            ...
                            <div class="card-inner card-inner-md">
                                <div class="user-card">
                                    ...
                                    <div class="user-info"><span class="lead-text">Sharon
                                            Walker</span><span
                                            class="sub-text">sharon-90@example.com</span></div>
                                    <div class="user-action">
                                        <div class="drodown"><a href="#"
                                                class="dropdown-toggle btn btn-icon btn-trigger me-n1"
                                                data-bs-toggle="dropdown"
                            ...
                            <div class="card-inner card-inner-md">
                                <div class="user-card">
                                    ...
                                    <div class="user-info"><span class="lead-text">Gloria
                                            Oliver</span><span
                                            class="sub-text">gloria_72@example.com</span></div>
                                    <div class="user-action">
                                        <div class="drodown"><a href="#"
                                                class="dropdown-toggle btn btn-icon btn-trigger me-n1"
                                                data-bs-toggle="dropdown"
                            ...
                            <div class="card-inner card-inner-md">
                                <div class="user-card">
                                    ...
                                    <div class="user-info"><span class="lead-text">Phillip
                                            Sullivan</span><span
                                            class="sub-text">phillip-85@example.com</span></div>
                                    <div class="user-action">
                                        <div class="drodown"><a href="#"
                                                class="dropdown-toggle btn btn-icon btn-trigger me-n1"
                                                data-bs-toggle="dropdown"
